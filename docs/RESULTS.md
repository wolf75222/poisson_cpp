...
[`python/plot_figures.py`](../python/plot_figures.py).
...
PYTHONPATH=build/python python3 python/plot_figures.py all
```

## Chiffres clés

| Cas | Mesure | Valeur | Attendu |
|---|---|---|---|
...
![Poisson 1D](figures/poisson_1d.png)
...
## Couches diélectriques 1D

![Diélectrique 1D](figures/dielectric_1d.png)
...
## Convergence spectrale O(h²)

![Convergence spectrale](figures/spectral_convergence.png)
...
## AMR quadtree sur Gaussienne

![AMR Gaussienne](figures/amr_gaussian.png)
